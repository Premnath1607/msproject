package com.tpn.zuulgateway.config;
...
/**
 * @classDesc: Unified exception handling, refer to
 *             {@link org.springframework.web.server.AbstractErrorWebExceptionHandler}
 * 
 */
public class JsonExceptionHandler implements ErrorWebExceptionHandler {
	...
	public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
		...
		log.error("[global exception handling] exception request path: {}, record exception information: {}",
